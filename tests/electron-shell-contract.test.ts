...
describe('Electron Desktop Shell contract', () => {
  ...
  it('keeps packaging focused on the desktop shell', () => {
    expect(builderConfig).toContain('productName: AI Sales Agent');
    expect(builderConfig).toContain('icon: assets/salesclaw-icon.png');
    expect(builderConfig).toContain('icon: assets/salesclaw.icns');
